...
def construct_subspace2(mf, mol_frag, ints, impurityOrbs, \
    ...
    for icol in xrange(numImpOrbs):
        counter = 0
        for irow in xrange(numTotalOrbs):
	...
	for j in xrange(_loc2sub.shape[-1]):
