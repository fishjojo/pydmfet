...
params = oep.OEPparams(algorithm = 'split', opt_method = 'L-BFGS-B', \
                       ftol = 1e-12, gtol = 1.0e-5,diffP_tol= 1.0e-5, outer_maxit = 200, maxit = 200,l2_lambda = 0.0, oep_print = 0)
...
theDMFET = sdmfet.DMFET( mf, mol_frag, mol_env,myInts,impurities, impAtom, Ne_frag, boundary_atoms=boundary_atoms, boundary_atoms2=boundary_atoms2,\
                         umat = None, dim_imp =nbas, dim_bath=nbas, dim_big =None, smear_sigma = 0.001, oep_params=params,ecw_method='hf', mf_method = mf.xc,\
			 use_umat_ao=False)
